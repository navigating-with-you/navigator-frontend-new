            ...
            <div className="w-full flex-1 flex flex-col min-h-0 overflow-x-auto">
                <div className="w-full flex-1 flex flex-col min-h-0">
                    ...
                    <div
                        ...
                        className="hidden md:grid items-center gap-2 bg-surface-sidebar dark:bg-[#171717] rounded-t-[10px] px-5 py-3 text-xs font-medium uppercase tracking-wide text-[#171717] dark:text-[#E7E7E0] shrink-0 select-none md:min-w-[800px] lg:min-w-full "
                    >
                        {canSelect && (
                            <div>
                                <Checkbox
