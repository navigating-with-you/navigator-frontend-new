    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    variant="outline"
                    className="flex items-center gap-1.5 h-6 px-2.5 rounded-md border-surface-sidebar dark:border-zinc-700 bg-surface-page dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 text-xs font-normal hover:bg-[#F5F5F0] dark:hover:bg-zinc-800 shadow-sm"
                >
